...
#import "JHMainVC.h"
@interface JHMaintainMapVC ()<UITextViewDelegate,UITextFieldDelegate>
{
    XHMapView *_mapView;
...
- (void)requestWitApi:(NSString *)api dic:(NSDictionary *)dic alert:(NSString *)alert{
    ...
    [HttpTool postWithAPI:api withParams:dic success:^(id json) {
        ...
        if([json[@"error"] isEqualToString:@"0"]){
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:@"maintainMapStautusButton" object:nil];
        }else{
            HIDE_HUD
