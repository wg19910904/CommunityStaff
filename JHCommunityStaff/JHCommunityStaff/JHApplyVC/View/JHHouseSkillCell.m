...
@implementation JHHouseSkillCell
{
    UIView *_skillView;
    UILabel *_skillLabel;
...
- (void)initSkillView{
    ...
    NSString *str = NSLocalizedString(@"通过单击以下标签选择家政技能", nil);
    NSRange range1 = [str rangeOfString:NSLocalizedString(@"选择家政技能", nil)];
...
- (void)clickSkillBnt:(UIButton *)sender{
    ...
    if(self.houseSkillBlock){
        self.houseSkillBlock(_skillDataArray);
    }
}
#pragma mark - 弹出警告款
-(void)showAlert{
